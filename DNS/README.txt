...
Файл DNSServer.py отвечает за разрешение запросов клиента и кэширование 
данных. Прослушивает 53 порт. При первом запуске кэш пустой (отсутствуют
сохраненные записи). При корректном завершении работы сервер сериализует
