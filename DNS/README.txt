...
(отсутствуют сохраненные записи). При корректном завершении работы сервер
сериализует данные из кэша, сохраняет в файл cache_data.pkl. При повторном
запуске кэш строится на основе сохраненных данных.
